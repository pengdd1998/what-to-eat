...
## 文档地图
- **技术**（`tech/`）：`tech/implementation-plan.md`（v3.1）、`tech/technical-requirements.md`（TRD v2，FR/HC/SC/SUP/RSK 编号源）、`tech/llm-integration-discussion.md`、`tech/ci-cd-plan.md`（GitHub CI/CD 方案 v1.5，2026-09-17 定稿未实施——公开仓脱敏/嵌套仓双正本（白名单 ignore＋切换原子序＋本地滞留物 ignore 补齐＋clean -x 禁令）/备案期断言分层/两期上线/待拍板项在内）
